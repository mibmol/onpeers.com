...
export const TIMEZONES: Tz[] = [
	...
	},
	{
		...
		label: '(GMT-07:00) Mexican Pacific Time - Chihuahua',
	},
	{
	...
	},
	{
		...
		label: '(GMT-07:00) Mountain Time (Dawson) - Dawson',
	},
	{
		value: 'America/Whitehorse',
		label: '(GMT-07:00) Mountain Time (Whitehorse) - Whitehorse',
	},
	{
	...
	},
	{
		...
		label: '(GMT-06:00) Central Time (Bahia Banderas) - Bahia Banderas',
	},
	{
		value: 'America/Merida',
		label: '(GMT-06:00) Central Time (Merida) - Merida',
	},
	{
		value: 'America/Mexico_City',
		label: '(GMT-06:00) Central Time (Mexico) - Mexico City',
	},
	{
		value: 'America/Monterrey',
		label: '(GMT-06:00) Central Time (Monterrey) - Monterrey',
	},
	{
	...
	{
		value: 'America/Nuuk',
		label: '(GMT-03:00) West Greenland Time',
	},
	{
	...
	{
		value: 'Asia/Amman',
		label: '(GMT+02:00) Eastern European Time - Amman',
	},
	{
		value: 'Europe/Athens',
	...
	{
		value: 'Asia/Damascus',
		label: '(GMT+02:00) Eastern European Time - Damascus',
	},
	{
		value: 'Asia/Gaza',
	...
	{
		value: 'Europe/Kiev',
		label: '(GMT+02:00) Eastern European Time - Kiev',
	},
	{
		value: 'Asia/Nicosia',
...
export const LOCAL_TIMEZONE_RAW: string = Intl.DateTimeFormat().resolvedOptions().timeZone;
export const LOCAL_TIMEZONE = TIMEZONES.find((tz) => tz.value === LOCAL_TIMEZONE_RAW);
